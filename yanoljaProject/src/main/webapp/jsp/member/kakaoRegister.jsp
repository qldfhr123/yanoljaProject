...
<div class="register">
	<div class="inner">
		...
		<div class="register_content">
			...
			<div class="register_individual">
				<form action="kakaoRegisterProc" method="post" id="f">
					<ul>
						<li>아이디</li>
						<li><input type="text" name="userId" style="width:500px; background:#eee;" value="${sessionScope.user_id }" readonly></li>
					</ul>
					<ul>
						<li>이메일</li>
						<li><input type="text" name="userEmail" style="width:500px; background:#eee;" value="${sessionScope.user_email }"  readonly></li>
					</ul>
					<ul>
						<li>이름</li>
					...
					<ul>
						...
						<li><input type="text" name="userDob" id="doc" style="display:none;" value="${sessionScope.userDob }"></li>
					</ul>
					<ul>
						<li>연락처</li>
		...
		<button class="Btn" onclick="kakaoRegisterCheck()">회원 가입</button>
